...
void CTerrainEditor::InitTerrainMenu()
{
	...
	if (pEditMenu)
	{
		...
		sec = pEditMenu->GetNextEmptySection();
		pEditMenu->AddAction(GetAction_Deprecated("terrain.stamp_plate_height"), sec);
		pEditMenu->AddAction(GetAction_Deprecated("terrain.stamp_plate_colour"), sec);
		pEditMenu->AddAction(GetAction_Deprecated("terrain.reposition_vegetation"), sec);
