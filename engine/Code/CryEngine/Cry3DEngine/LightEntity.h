...
public:
	...
	int                                  UpdateGSMLightSourceLPVRsmFrustum(int nFrustumIndex, int nCacheLod, int nCascadeCount, const SRenderingPassInfo& passInfo);
	static int                           GetLPVRsmCascadeCount();
	int                                  UpdateGSMLightSourceNearestShadowFrustum(int nFrustumIndex, const SRenderingPassInfo& passInfo);
	static bool                          IsLPVRsmEnabled();
