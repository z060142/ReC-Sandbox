...
#define e_VegetationSpritesScaleFactorDefault              (1.0f)
	...
	float e_TerrainIntegrateObjectsMaxHeight;
	int   e_TerrainIntegrateObjectsDebug;
	int   e_TerrainIntegrateObjectsRebuildDelay;
	int   e_TerrainIntegrateObjectsFull;
	float e_TerrainIntegrateObjectsPushOut;
	float e_TerrainIntegrateObjectsLodHoldDistance;
	float e_TerrainIntegrateObjectsNormalBlendHeight;
	...
	float e_RoadsZOffset;
	int   e_RoadsFollowIntegratedObjects;
	int   e_RoadsFollowIntegratedObjectsSubdiv;
