...
void CStretchRegionPass::Execute(CTexture* pSrcRT, CTexture* pDestRT, const RECT* pSrcRect, const RECT* pDstRect, bool bBigDownsample, const ColorF& color, const uint64 renderStateFlags)
{
	if (pSrcRT == NULL || pDestRT == NULL)
		return;
	...
	uint64 renderState = GS_NODEPTHTEST | renderStateFlags;
...
bool CStretchRegionPass::PreparePrimitive(CRenderPrimitive& prim, CPrimitiveRenderPass& targetPass, const RECT& rcS, uint64 renderState, const D3DViewPort& targetViewport, bool bResample, bool bBigDownsample, CTexture* pSrcRT, CTexture* pDestRT, const ColorF& color)
{
...
bool CClearRegionPass::PreparePrimitive(CRenderPrimitive& prim, uint64 renderState, int stencilState, const ColorF& cClear, float cDepth, int stencilRef, const RECT& rect, const D3DViewPort& targetViewport, int numRTVs)
{
