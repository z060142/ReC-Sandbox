...
public:
	...
	int                             nShadowCacheLod;
	uint8                           nLpvCascadeIndex = 0;         // e_LPVRsm only: which LPV cascade this RSM view feeds
	uint32                          m_Flags;
